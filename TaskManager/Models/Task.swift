...
struct Task: Identifiable, Hashable {
    ...
    static func examples() -> [Task] {
        ...
        Task(title: "the misfits, the rebels, the troublemakers", dueDate: Calendar.current.date(byAdding: .day, value: 1, to: Date())!),
        Task(title: "the ones who see things differently -they're not fond of rules..."),
        Task(title: "You can quote the, disagree with them, glorify or vilify them"),
